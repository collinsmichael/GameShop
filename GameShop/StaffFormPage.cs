...
namespace GameShop
{
    ...
    public class StaffEditPage : Page
    {
        ...
        public void OnEditSubmitClick(object sender, EventArgs e)
        {
            ...
            staff.SetUserName((Form1.formgen.GetControl("staff.edit", "username") as TextBox).Text);
            staff.SetFirstName((Form1.formgen.GetControl("staff.edit", "firstname") as TextBox).Text);
            staff.SetSurname((Form1.formgen.GetControl("staffedit", "surname") as TextBox).Text);
            staff.SetEmail((Form1.formgen.GetControl("staff.edit", "email") as TextBox).Text);
            staff.SetPhoneNo((Form1.formgen.GetControl("staff.edit", "phone") as TextBox).Text);
            staff.SetAddress((Form1.formgen.GetControl("staff.edit", "address") as TextBox).Text);
            staff.SetDateOfBirth((Form1.formgen.GetControl("staff.edit", "dateofbirth") as TextBox).Text);
            staff.SetPassWord((Form1.formgen.GetControl("staff.edit", "password") as TextBox).Text);
    ...
    public class StaffMakePage : Page
    {
        ...
        public override void DefinePage()
        {
            ...
            make.Add("header", new WidgetTitle("New Staff Member"));
        ...
        public void OnMakeSubmitClick(object sender, EventArgs e)
        {
            ...
            staff.SetUserName((Form1.formgen.GetControl("staff.make", "username") as TextBox).Text);
            staff.SetFirstName((Form1.formgen.GetControl("staff.make", "firstname") as TextBox).Text);
            staff.SetSurname((Form1.formgen.GetControl("staff.make", "surname") as TextBox).Text);
            staff.SetEmail((Form1.formgen.GetControl("staff.make", "email") as TextBox).Text);
            staff.SetPhoneNo((Form1.formgen.GetControl("staff.make", "phone") as TextBox).Text);
            staff.SetAddress((Form1.formgen.GetControl("staff.make", "address") as TextBox).Text);
            staff.SetDateOfBirth((Form1.formgen.GetControl("staff.make", "dateofbirth") as TextBox).Text);
            staff.SetPassWord((Form1.formgen.GetControl("staff.make", "password") as TextBox).Text);
