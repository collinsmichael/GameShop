    ...
    class BlackList {
        ...
        public BlackList() {
            ...
            List<string> userblacklist = new List<string> {
                ...
                "reports.list", "reports.view", "reports.edit", "reports.make", "reports.drop",
                "header.page"
            };

            List<string> staffblacklist = new List<string> {
                "staff.list",        "staff.view",        "staff.edit",        "staff.make",        "staff.drop",
                "game.drop",         "game.view.edit",    "game.list.delete",
                "order.drop",        "order.list.delete",
                "report.drop",       "report.list.delete",
                "header.page.staff"
            };
        ...
        public bool IsBlackListed(string control) {
            Staff logged = Form1.context.GetLogged("staff") as Staff;
