...
namespace GameShop {
    ...
    public class LogOnPage : Page {
        ...
        public override void DefinePage() {
            ...
            widgets.Add("username", new WidgetTextBox(272, 196, 320, 32, "", false, false, false, 0));
            widgets.Add("password", new WidgetTextBox(272, 236, 320, 32, "", false, false, true, 1));
            widgets.Add("submit",   new WidgetButton(464, 320, 128, 32, "Submit", OnSubmit, 2));
            widgets.Add("exit",     new WidgetButton(272, 320, 128, 32, "Exit", OnExit, 3));
