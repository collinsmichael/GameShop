...
// File Info : The Widget class is a wrapper around the Form.Controls class. //
// ========================================================================= //
...
namespace GameShop {
    ...
    public class WidgetLabel : Widget {
        ...
        public override Control Build() {
            Label label     = new Label();
            label.Text      = text;
            label.Font      = new Font("Verdana", 12.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            label.Location  = new Point(posx, posy);
            label.Size      = new Size(wide, high);
            label.BackColor = Color.Transparent;
            label.TabStop   = false;
    ...
    public class WidgetButton : Widget {
        ...
        public WidgetButton(int PosX, int PosY, int Wide, int High,
                            string Text, Action<object, EventArgs> Method, int TabIndex)
        : base(PosX, PosY, Wide, High) {
            text     = Text;
            method   = Method;
            tabindex = TabIndex;
